...
ANDROIDAUDIO_OpenDevice(_THIS, void *handle, const char *devname, int iscapture)
{
	...
	LOGI("sound_bringup: In ANDROIDAUDIO_OpenDevice, calling Android_JNI_OpenAudioDevice.  iscapture: %d  freq: %d  format: %d  channels: %d  samples: %d", iscapture, this->spec.freq, this->spec.format, this->spec.channels, this->spec.samples);
...
{
	LOGI("In ANDROIDAUDIO_PlayDevice, top of routine, before Android_JNI_WriteAudioBuffer.");
...
{
	// 2017.09.21 - RJS - not supporting capture audio
