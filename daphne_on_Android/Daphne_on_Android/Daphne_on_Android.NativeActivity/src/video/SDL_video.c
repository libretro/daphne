...
SDL_VideoInit(const char *driver_name)
{
	...
	LOGI("daphne-libretro: In SDL_VideoInit, top of routine.");
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, before SDL_InitSubSystem.");
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after SDL_InitSubSystem.");
    ...
    if (driver_name == NULL) {
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, driver_name is null, first check.");
        driver_name = SDL_getenv("SDL_VIDEODRIVER");
    }

	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, final driver_name: %s", driver_name);
    if (driver_name != NULL) {
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after driver_name check: %s  video: %d", driver_name, (int) video);
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after saving off video device information: %s  video: %d", bootstrap[i]->name, (int) video);
    ...
    if (_this->VideoInit(_this) < 0) {
        SDL_VideoQuit();
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, VideoInit error and exit.");
        return -1;
    }
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after VideoInit success.");

    /* Make sure some displays were added */
    if (_this->num_displays == 0) {
        SDL_VideoQuit();
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, VideoInit no displays error and exit.");
    ...
    if (ShouldUseTextureFramebuffer()) {
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, inside ShouldUseTextureFramebuffer.");
        _this->CreateWindowFramebuffer = SDL_CreateWindowTexture;
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, after SDL_CreateWindowTexture.  CreateWindowFramebuffer: %d", (int) _this->CreateWindowFramebuffer);
        _this->UpdateWindowFramebuffer = SDL_UpdateWindowTexture;
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, after SDL_UpdateWindowTexture.  UpdateWindowFramebuffer: %d", (int) _this->UpdateWindowFramebuffer);
        _this->DestroyWindowFramebuffer = SDL_DestroyWindowTexture;
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, after SDL_DestroyWindowTexture.  DestroyWindowFramebuffer: %d", (int) _this->DestroyWindowFramebuffer);
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In SDL_VideoInit, exiting inside ShouldUseTextureFramebuffer.");
    }
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after ShouldUseTextureFramebuffer.");
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after screensaver disable code.");
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, after screen keyboard check.  Has: %d", SDL_HasScreenKeyboardSupport());

    /* We're ready to go! */
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In SDL_VideoInit, bottom of routine.");
    return 0;
}
...
#define CREATE_FLAGS \
    (SDL_WINDOW_BORDERLESS | SDL_WINDOW_RESIZABLE | SDL_WINDOW_ALLOW_HIGHDPI | SDL_WINDOW_ALWAYS_ON_TOP | SDL_WINDOW_SKIP_TASKBAR | SDL_WINDOW_POPUP_MENU | SDL_WINDOW_UTILITY | SDL_WINDOW_TOOLTIP)
