...
// RJS CHANGE - to get rid of incompatible pointer warnings
// ORIG #define SDL_PROC(ret,func,params) ret (APIENTRY *func) params;
// #define SDL_PROC(ret,func,params) ret (*func) params;
#define SDL_PROC(ret,func,params) ret (__attribute__((pcs("aapcs"))) *func) params;
