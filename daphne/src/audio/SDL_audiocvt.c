    ...
    case AUDIO_U8:
        {
            ...
            src = (uint8_t *) (cvt->buf + cvt->len_cvt);
            dst = (uint8_t *) (cvt->buf + cvt->len_cvt * 3);
    ...
    case AUDIO_U8:
        {
            ...
            src = (uint8_t *) (cvt->buf + cvt->len_cvt);
            dst = (uint8_t *) (cvt->buf + cvt->len_cvt * 2);
            for (i = cvt->len_cvt; i; --i) {
                dst -= 4;
                src -= 2;
                lf = src[0];
