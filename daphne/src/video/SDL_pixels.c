...
static uint8_t lookup_3[] = {
0, 8, 16, 24, 32, 41, 49, 57, 65, 74, 82, 90, 98, 106, 115, 123, 131, 139, 148, 156, 164, 172, 180, 189, 197, 205, 213, 222, 230, 238, 246, 255
};

static uint8_t lookup_4[] = {
0, 17, 34, 51, 68, 85, 102, 119, 136, 153, 170, 187, 204, 221, 238, 255
};

static uint8_t lookup_5[] = {
0, 36, 72, 109, 145, 182, 218, 255
};

static uint8_t lookup_6[] = {
0, 85, 170, 255
};

static uint8_t lookup_7[] = {
0, 255
};

static uint8_t lookup_8[] = {
255
};

uint8_t* SDL_expand_byte[9] = {
    lookup_0,
    lookup_1,
    lookup_2,
    lookup_3,
...
SDL_AllocPalette(int ncolors)
{
    ...
    palette = (SDL_Palette *)malloc(sizeof(*palette));
    if (!palette) {
        SDL_OutOfMemory();
        return NULL;
    }
    palette->colors =
        (SDL_Color *)malloc(ncolors * sizeof(*palette->colors));
    if (!palette->colors) {
        free(palette);
        return NULL;
    }
 ...
 */
uint8_t
SDL_FindColor(SDL_Palette * pal, uint8_t r, uint8_t g, uint8_t b, uint8_t a)
{
...
static uint8_t *
Map1toN(SDL_PixelFormat * src, uint8_t Rmod, uint8_t Gmod, uint8_t Bmod, uint8_t Amod,
        SDL_PixelFormat * dst)
{
    uint8_t *map;
    int i;
...
SDL_AllocBlitMap(void)
{
    ...
    map = (SDL_BlitMap *)calloc(1, sizeof(*map));
    if (map == NULL) {
        SDL_OutOfMemory();
        return (NULL);
    }
