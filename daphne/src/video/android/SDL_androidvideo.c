...
{
	// 2017.09.21 - RJS - screen saver suspend should happen in RA
...
Android_VideoInit(_THIS)
{
	...
	LOGI("daphne-libretro: In Android_VideoInit, top of routine.");
	...
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, before SDL_AddBasicVideoDisplay.");
    if (SDL_AddBasicVideoDisplay(&mode) < 0) {
		// 2017.02.07 - RJS ADD - Logging.
		LOGI("daphne-libretro: In Android_VideoInit, SDL_AddBasicVideoDisplay error.");
        return -1;
    }
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, after SDL_AddBasicVideoDisplay success.");

    SDL_AddDisplayMode(&_this->displays[0], &mode);
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, after SDL_AddDisplayMode.  Display: %d  Mode: %d", (int) &_this->displays[0], (int) &mode);

    Android_InitKeyboard();
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, after Android_InitKeyboard.");

    Android_InitTouch();
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, after Android_InitTouch.");

    /* We're done! */
	// 2017.02.07 - RJS ADD - Logging.
	LOGI("daphne-libretro: In Android_VideoInit, bottom of routine.");
    return 0;
}
