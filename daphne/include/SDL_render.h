...
// 2017.08.25 - RJS - Assuming this writing of using buffers works, this needs to be
// officialized as an external structure.  Brute force copy it over until it's proven.
